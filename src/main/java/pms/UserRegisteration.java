...
public class UserRegisteration extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String sql = "INSERT INTO users (firstname, lastname, username, password, mobile) VALUES (?, ?, ?, ?, ?)";
            ...
            if (row > 0) {
                out.println("<html><body><h3>Registration successful! please </h3><a href=\"userLogin.html\">login</a></body></html>");
